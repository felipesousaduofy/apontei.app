 ...
 * quadro, só que sem precisar sair do dashboard. Entra em "A fazer"; prazo,
 * projeto e descrição completos ficam para quem abrir o cartão no quadro.
 */
export default function DialogoNovaTarefa({ aoFechar, aoCriar }) {
  ...
  async function enviar(e) {
    ...
    setErro('');
    setCriando(true);
    const ok = await aoCriar({ titulo: t, chamado: chamado.trim(), prioridade });
    setCriando(false);
        ...
        <div className="dlg__corpo">
          ...
          <div className="linha-campos">
            <div className="campo-grupo">
              ...
              <input
                id="nt-chamado" className="campo" placeholder="opcional"
          ...
          <p className="ajuda">
            Entra na coluna A fazer. Projeto, prazo e descrição dá para completar
